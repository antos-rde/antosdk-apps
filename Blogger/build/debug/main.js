(function() {
  ...
  var Ant, BlogPostListItemTag, Blogger, BloggerCVSectionDiaglog, BloggerCategoryDialog, BloggerSendmailDiaglog, CVSectionListItemTag;

  Blogger = class Blogger extends this.OS.application.BaseApplication {
    constructor(args) {
      super("Blogger", args);
    }
    ...
    main() {
      ...
      (this.find("cv-cat-add")).onbtclick = (e) => {
        return this.fetchCVCat().then((tree) => {
          return this.openDialog(new BloggerCategoryDialog(), {
            ...
            return this.cvcatdb.save(c).then((r) => {
              return this.refreshCVCat();
            }).catch((e) => {
              return this.error(__("Cannot add new category"), e);
            });
          }).catch((e) => {
            return this.error(e.toString(), e);
          });
        }).catch((e) => {
          return this.error(__("Unable to fetch categories"), e);
        });
      };
      (this.find("cv-cat-edit")).onbtclick = (e) => {
        var cat, sel;
        sel = this.cvlist.selectedItem;
        if (!sel) {
          return;
        }
        cat = sel.data;
        ...
        return this.fetchCVCat().then((tree) => {
          return this.openDialog(new BloggerCategoryDialog(), {
            ...
            return this.cvcatdb.save(c).then((r) => {
              ...
              return this.error(__("Cannot Edit category"), e);
            });
          });
        }).catch((e) => {
          return this.error(__("Unable to fetch categories"), e);
      ...
      (this.find("cv-cat-del")).onbtclick = (e) => {
        var cat, sel;
        sel = this.cvlist.selectedItem;
        if (!sel) {
          return;
        ...
        return this.openDialog("YesNoDialog", {
          ...
          return this.deleteCVCat(cat);
        }).catch((e) => {
          return this.error(e.toString(), e);
        });
      };
      (this.find("cv-sec-add")).onbtclick = (e) => {
        var cat, sel;
        sel = this.cvlist.selectedItem;
        if (!sel) {
          return;
        ...
        cat = sel.data;
        if (!(cat && cat.id !== "0")) {
          return this.notify(__("Please select a category"));
        }
        return this.openDialog(new BloggerCVSectionDiaglog(this), {
          ...
          d.end = Number(d.end);
          // d.publish = 1
          return this.cvsecdb.save(d).then((r) => {
            return this.CVSectionByCID(Number(cat.id));
          }).catch((e) => {
            return this.error(__("Cannot save section: {0}", e.toString()), e);
          });
        });
      };
      (this.find("cv-sec-move")).onbtclick = (e) => {
        var sec, sel;
        sel = (this.find("cv-sec-list")).selectedItem;
        if (!sel) {
          return this.notify(__("Please select a section to move"));
        }
        sec = sel.data;
        return this.fetchCVCat().then((tree) => {
          return this.openDialog(new BloggerCategoryDialog(), {
            ...
            return this.cvsecdb.save(c).then((r) => {
              this.CVSectionByCID(sec.cid);
              return (this.find("cv-sec-list")).unselect();
            }).catch((e) => {
              return this.error(__("Cannot move section"), e);
            });
          });
        });
      };
      (this.find("cv-sec-edit")).onbtclick = (e) => {
        var sec, sel;
        sel = (this.find("cv-sec-list")).selectedItem;
        if (!sel) {
          return this.notify(__("Please select a section to edit"));
        }
        sec = sel.data;
        return this.openDialog(new BloggerCVSectionDiaglog(this), {
          ...
          return this.cvsecdb.save(d).then((r) => {
            return this.CVSectionByCID(Number(sec.cid));
          }).catch((e) => {
            return this.error(__("Cannot save section: {0}", e.toString()), e);
          });
        });
      };
      this.seclist.onitemclose = (e) => {
        var data;
        if (!e) {
          return;
        }
        ...
        this.openDialog("YesNoDialog", {
          ...
          return this.cvsecdb.delete(data.id).then((r) => {
            return this.seclist.delete(e.data.item);
          }).catch((e) => {
      ...
      this.editor = new SimpleMDE({
        ...
        toolbar: [
              ...
              return this.openDialog("FileDialog",
          {
                ...
                return d.file.path.asFileHandle().publish().then((r) => {
                  var doc;
                  doc = this.editor.codemirror.getDoc();
                  return doc.replaceSelection(`![](${this._api.handle.shared}/${r.result})`);
                }).catch((e) => {
                  return this.error(__("Cannot export file for embedding to text"),
          e);
                });
              });
            }
          ...
          "|",
          {
            ...
            action: (e) => {
              ...
              return renderMathInElement(this.find("editor-container"));
            }
          },
          "|",
          {
            ...
            action: (e) => {
              var data,
          sel;
              sel = this.bloglist.selectedItem;
              if (!sel) {
                return this.error(__("No post selected"));
              }
              data = sel.data;
              return this.openDialog(new BloggerSendmailDiaglog(this),
          {
                title: __("Send mail"),
      ...
      this.bloglist.onlistselect = (e) => {
        ...
        return this.blogdb.get(Number(sel.id)).then((r) => {
          this.editor.value(atob(r.content));
      ...
      this.bloglist.onitemclose = (e) => {
        ...
        this.openDialog("YesNoDialog", {
          ...
          return this.blogdb.delete(data.id).then((r) => {
      ...
      this.bindKey("CTRL-S", () => {
        var sel;
        sel = this.tabcontainer.selectedTab;
    ...
    fetchData(idx) {
      switch (idx) {
        case "user-container": //user info
          return this.userdb.get(null).then((d) => {
            ...
            for (i = 0, len = inputs.length; i < len; i++) {
              v = inputs[i];
              results.push(($(v)).val(this.user[v.name]));
            }
            return results;
          }).catch((e) => {
            return this.error(__("Cannot fetch user data"), e);
          });
    ...
    saveUser() {
      ...
      if (!this.user.fullname || this.user.fullname === "") {
        return this.notify(__("Full name must be entered"));
      }
      //console.log @user
      return this.userdb.save(this.user).then((r) => {
        return this.notify(__("User data updated"));
      }).catch((e) => {
        return this.error(__("Cannot save user data"), e);
      });
    }
    ...
    refreshCVCat() {
      return this.fetchCVCat().then((data) => {
        ...
        return this.error(__("Unable to load categories"), e);
      });
    }
    ...
    fetchCVCat() {
      return new Promise((resolve, reject) => {
        ...
        return this.cvcatdb.find(cnd).then((d) => {
    ...
    deleteCVCat(cat) {
      ...
      return this.cvsecdb.delete({
        ...
        return this.cvcatdb.delete({
          "or": cond
        }).then((re) => {
          this.refreshCVCat();
          return this.seclist.data = [];
        }).catch((e) => {
          return this.error(__("Cannot delete the category: {0} [{1}]", cat.name, e.toString()), e);
        });
      }).catch((e) => {
        return this.error(__("Cannot delete all content of: {0} [{1}]", cat.name, e.toString()), e);
      });
    }
    ...
    CVSectionByCID(cid) {
      ...
      return this.cvsecdb.find(cond).then((d) => {
        var i, items, len, v;
        items = [];
        ...
        return this.seclist.data = items;
      }).catch((e) => {
        return this.error(e.toString(), e);
      });
    }
    ...
    // blog
    saveBlog() {
      var content, d, data, sel, selel, tags, title;
      sel = void 0;
      selel = this.bloglist.selectedItem;
      if (selel) {
        sel = selel.data;
      }
      ...
      if (!(title && title.length === 2)) {
        return this.notify(__("Please insert a title in the text: beginning with heading"));
      }
      if (tags === "") {
        return this.notify(__("Please enter tags"));
      }
      d = new Date();
      data = {
      ...
      //save the data
      return this.blogdb.save(data).then((r) => {
        return this.loadBlogs();
      }).catch((e) => {
        return this.error(__("Cannot save blog: {0}", e.toString()), e);
      });
    }

    process(text) {
      var begin, embed, found, i, it, len, re, replace, ret;
...
></iframe>`;
      ...
      if (!(replace.length > 0)) {
        return text.asBase64();
      }
      ret = "";
      begin = 0;
      for (i = 0, len = replace.length; i < len; i++) {
        it = replace[i];
    ...
    loadBlogs() {
      ...
      cond = {
        ...
        fields: ["id", "title", "ctimestr", "ctime", "utime", "utimestr"]
      };
      return this.blogdb.find(cond).then((r) => {
        var i, len, v;
        ...
        return this.error(__("No post found: {0}", e.toString()), e);
      });
    }
  ...
  Blogger.dependencies = ["os://scripts/mde/simplemde.min.js", "os://scripts/mde/simplemde.min.css"];
  ...
  // General Public License for more details.
    ...
    // You should have received a copy of the GNU General Public License
  //along with this program. If not, see https://www.gnu.org/licenses/.
  BloggerCategoryDialog = class BloggerCategoryDialog extends this.OS.GUI.BasicDialog {
    constructor() {
  ...
  BloggerCategoryDialog.scheme = `<afx-app-window width='300' height='400'>
    <afx-vbox>
  ...
  BloggerCVSectionDiaglog = class BloggerCVSectionDiaglog extends this.OS.GUI.BasicDialog {
    constructor(parent) {
      var file;
    ...
    main() {
      ...
      if (this.data && this.data.section) {
        (function() {
          ...
          for (i = 0, len = inputs.length; i < len; i++) {
            v = inputs[i];
            results.push(($(v)).val(this.data.section[v.name]));
          }
          return results;
        }).call(this);
      }
      ...
      (this.find("bt-cv-sec-save")).onbtclick = (e) => {
        ...
        val = (this.find("section-publish")).swon;
        if (val === true) {
          data.publish = 1;
        } else {
          data.publish = 0;
  ...
  BloggerSendmailDiaglog = class BloggerSendmailDiaglog extends this.OS.GUI.BasicDialog {
    constructor(parent) {
      var file;
    ...
    main() {
      ...
      this.subdb.find({}).then((d) => {
        ...
        return this.maillinglist.items = d;
      }).catch((e) => {
        return this.error(__("Cannot fetch subscribers data: {0}", e.toString()), e);
      });
      return (this.find("bt-sendmail")).onbtclick = (e) => {
        var data, emails, i, items, len, v;
        ...
        // send the email
        data = {
          path: `${this.parent.path()}/sendmail.lua`,
          parameters: {
            to: emails,
        ...
        return this._api.apigateway(data, false).then((d) => {
          if (d.error) {
  ...
  BloggerSendmailDiaglog.template = `Hello,
...
Sent from Blogger, an AntOS application`;
  ...
  CVSectionListItemTag = class CVSectionListItemTag extends this.OS.GUI.tag.ListViewItemTag {
    constructor() {
      super();
    }

    ondatachange() {
      var el, k, nativel, ref, results, v;
      if (!this.data) {
        return;
      }
      v = this.data;
        ...
        children: [
          {
            el: "afx-label",
            ref: "title",
            class: "afx-cv-sec-title"
          },
          {
            el: "afx-label",
            ref: "subtitle",
            class: "afx-cv-sec-subtitle"
          },
          {
            el: "p",
            ref: "content",
            class: "afx-cv-sec-content"
          },
          {
            el: "p",
            class: "afx-cv-sec-period",
            children: [
              {
                el: "i",
                ref: "start"
  ...
  BlogPostListItemTag = class BlogPostListItemTag extends this.OS.GUI.tag.ListViewItemTag {
    constructor() {
      super();
    }
    ...
    ondatachange(v) {
      ...
      return this.refs.utimestr.text = __("Updated: {0}", v.utimestr);
    }
